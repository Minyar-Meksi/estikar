                        ...
                        <thead class="text-gray-700">
                            <tr>
                                <th class="px-4 py-3 text-left">
                                    @lang('crud.versions.inputs.name')
                                </th>
                                <th class="px-4 py-3 text-left">
                                    @lang('crud.versions.inputs.modele_id')
                                </th>
                                <th class="px-4 py-3 text-left">
                                    @lang('crud.versions.inputs.picture')
                                </th>
                                <th class="px-4 py-3 text-right">
                                    @lang('crud.versions.inputs.year')
                                </th>
                                <th></th>
                            </tr>
                        </thead>
