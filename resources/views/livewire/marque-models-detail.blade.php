<div>
    <div>
        ...
        <button class="button" wire:click="newModele">
            <i class="mr-1 icon ion-md-add text-primary"></i>
            @lang('crud.common.new')
        </button>
        @endcan @can('delete-any', App\Models\Modele::class)
        <button
    ...
    <div class="block w-full overflow-auto scrolling-touch mt-4">
        <table class="w-full max-w-full mb-4 bg-transparent">
            <thead class="text-gray-700">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left">
                        @lang('crud.marque_models.inputs.name')
                    </th>
                    <th></th>
                </tr>
            </thead>
                    ...
                    <td class="px-4 py-3 text-right" style="width: 134px;">
                        ...
                        >
                            ...
                            <button
                                type="button"
                                class="button"
                                wire:click="editModele({{ $modele->id }})"
                            >
            ...
            <tfoot>
                <tr>
                    <td colspan="2">
                        <div class="mt-10 px-4">{{ $modeles->render() }}</div>
                    </td>
                </tr>
            </tfoot>
        </table>
