        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-dropdown title="Apps" align="right" width="48">
                        ...
                        @endcan
                        @can('view-any', App\Models\Marque::class)
                        <x-dropdown-link href="{{ route('marques.index') }}">
                        Marques
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Modele::class)
                        <x-dropdown-link href="{{ route('modeles.index') }}">
                        Models
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\Option::class)
                        <x-dropdown-link href="{{ route('options.index') }}">
                        Options
                        </x-dropdown-link>
                        @endcan
                        @can('view-any', App\Models\SousOption::class)
                        <x-dropdown-link href="{{ route('sous-options.index') }}">
                        Sous Options
                        </x-dropdown-link>
                        @endcan
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard') }}" :active="request()->routeIs('dashboard')">
                ...
                @endcan
                @can('view-any', App\Models\Marque::class)
                <x-jet-responsive-nav-link href="{{ route('marques.index') }}">
                Marques
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Modele::class)
                <x-jet-responsive-nav-link href="{{ route('modeles.index') }}">
                Models
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\Option::class)
                <x-jet-responsive-nav-link href="{{ route('options.index') }}">
                Options
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\SousOption::class)
                <x-jet-responsive-nav-link href="{{ route('sous-options.index') }}">
                Sous Options
                </x-jet-responsive-nav-link>
                @endcan
                @can('view-any', App\Models\User::class)
